...
.seh_proc chol_FactorizeAndSolveFwd_a
  ...
  jz .start_even
   ...
   .odd_top_rows_loop:
    ...
    vpermilpd $5,   %ymm3,%ymm5         # ymm5 = vx                    { im re im re }
    vmulpd    %ymm3,%ymm1,%ymm3         # ymm3 = vx.re*r0.re vx.im*r0.re
    vmulpd    %ymm5,%ymm2,%ymm5         # ymm5 = vx.im*r0.im vx.re*r0.im
    vaddsubpd %ymm5,%ymm3,%ymm3         # ymm4 =       vx.re*r0.re-vx.im*r0.im       vx.im*r0.re+vx.re*r0.im
    vsubpd    %ymm3,%ymm4,%ymm4         # ymm4 = vr.re-vx.re*r0.re+vx.im*r0    vr.im-vx.im*r0.re-vx.re*r0.im
...
.even_loop:
  ...
  vperm2f128 $0,%ymm5,%ymm5,%ymm5       # ymm5 = r0.im      x4
  vperm2f128 $0,%ymm6,%ymm6,%ymm6       # ymm6 = r1.re      x4
  vperm2f128 $0,%ymm7,%ymm7,%ymm7       # ymm7 = r1.im      x4
  ...
  .top_rows_loop:
    ...
    vmulpd    %ymm8, %ymm4,%ymm12       # ymm12= vx0.re*r0.re vx0.im*r0.re
    ...
    vmulpd    %ymm8, %ymm5, %ymm11      # ymm11= vx0.im*r0.im vx0.re*r0.im
    vaddsubpd %ymm11,%ymm12,%ymm12      # ymm12=       vx0.re*r0.re-vx0.im*r0.im       vx0.re*r0.im+vx0.im*r0.re
    vsubpd    %ymm12,%ymm10,%ymm10      # ymm10= vr.re-vx0.re*r0.re+vx0.im*r0.im vr.im-vx0.re*r0.im-vx0.im*r0.re

    vmulpd    %ymm9, %ymm1, %ymm9       # ymm9 = vx1 = (vx1 - vx0*conj(f))*aa1InvSqrt (re im re im)
    vmovupd   %ymm9, (%rdi,%rbx)        # x1[c] = vx1

    vmulpd    %ymm9, %ymm6, %ymm12      # ymm12= vx1.re*r1.re vx1.im*r1.re
    vpermilpd $5,  %ymm9,%ymm9          # ymm9 = vx1                       { im re im re }
    vmulpd    %ymm9, %ymm7,%ymm11       # ymm11= vx1.im*r1.im vx1.re*r1.im
    vaddsubpd %ymm11,%ymm12,%ymm12      # ymm10=       vx1.re*r1.re-vx1.im*r1.im       vx1.im*r1.re+vx1.re*r1.im
    vsubpd    %ymm12,%ymm10,%ymm10      # ymm10= vr.re-vx1.re*r1.re+vx1.im*r1.im vr.im-vx1.im*r1.re-vx1.re*r1.im
