...
.seh_proc chol_FactorizeAndSolveFwd_a
  ...
  jz .start_even
   ...
   .odd_top_rows_loop:
    ...
    vsubpd  %ymm5, %ymm4,%ymm4          # ymm4= vr.re-vx.re*r0.re vr.im-vx.im*r0.re
    vpermilpd $5,  %ymm3,%ymm3          # ymm3 = vx { im re im re }
    vmulpd  %ymm3, %ymm2,%ymm3
    vsubpd  %ymm3, %ymm4,%ymm4          # ymm4= vr.re+vx.im*r0.im vr.im-vx.re*r0.im
...
.even_loop:
  ...
  .top_rows_loop:
    ...
    vmulpd  %ymm8, %ymm4,%ymm11
    vsubpd  %ymm11,%ymm10,%ymm10        # ymm10= vr.re-vx0.re*r0.re vr.im-vx0.im*r0.re

    vpermilpd $5,  %ymm8,%ymm8          # ymm8 = vx0 { im re im re }

    vmulpd  %ymm8, %ymm3,%ymm11
    vaddpd  %ymm11,%ymm9,%ymm9          # ymm9 = vx1.re-vx0.im*f.im vx1.im+vx0.re*f.im

    vmulpd  %ymm8, %ymm5,%ymm11
    vsubpd  %ymm11,%ymm10,%ymm10        # ymm10= vr.re+vx0.im*r0.im vr.im-vx0.re*r0.im

    vmulpd  %ymm9, %ymm1, %ymm9         # ymm9 = vx1 = (vx1 - vx0*conj(f))*aa1InvSqrt (re im re im)
    vmovupd %ymm9, (%rdi,%rbx)          # x1[c] = vx1

    vmulpd  %ymm9, %ymm6,%ymm11
    vsubpd  %ymm11,%ymm10,%ymm10        # ymm10= vr.re-vx1.re*r1.re vr.im-vx1.im*r1.re
    vpermilpd $5,  %ymm9,%ymm9          # ymm9 = vx1 { im re im re }
    vmulpd  %ymm9, %ymm7,%ymm11
    vsubpd  %ymm11,%ymm10,%ymm10        # ymm10= vr.re+vx1.im*r1.im vr.im-vx1.re*r1.im
  ...
  .caxpy2x2_outer_loop:
    ...
    .caxpy2x2_inner_loop:
      ...
      vaddpd  %ymm12,%ymm10,%ymm10      # ymm10= vy0.re-vx1.im*f10.im vy0.im+vx1.re*f10.im
      vmulpd  %ymm9, %ymm7, %ymm12
      vaddpd  %ymm12,%ymm11,%ymm11      # ymm11= vy1.re-vx1.im*f11.im vy1.im+vx1.re*f11.im
