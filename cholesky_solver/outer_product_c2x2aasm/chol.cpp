...
extern "C" {
bool chol_FactorizeAndSolveFwd_a(std::complex<double>* triang, unsigned N, std::complex<double>* result);
bool chol_Factorize_a(std::complex<double>* triang, unsigned N);
void chol_SolveFwd_a(std::complex<double> *x, unsigned N, const std::complex<double>* triang);
void chol_SolveBwd_a(std::complex<double> *x, unsigned N, const std::complex<double>* triang);
}
