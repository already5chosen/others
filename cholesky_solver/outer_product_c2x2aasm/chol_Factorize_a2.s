...
#  .p2align  3, 0x90
    ...
    add $32,  %rcx                      # rcx = triang += 2
  dec %r10d                             # --chlen
  jnz .caxpy2x2_outer_loop

  add %rbx, %rcx                        # rcx = triang = x0 + (x1-x0)
.even_loop_entry:
  # RDX = rhlen
  mov %edx, %ebx
